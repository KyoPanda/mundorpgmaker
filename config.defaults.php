...
// Skins and Plugins.
$config["esoTalk.skin"] = "MRM4Ever"; // The active skin.
$config["esoTalk.mobileSkin"] = "MRM4Ever"; // The active skin for mobile devices.
$config["esoTalk.adminSkin"] = "MRM4Ever"; // The active skin for the administrator section.
